...
// contract VaultHelperForkTest is Test {
...
//         // 
//         // Note: This is a unit test that uses mock contracts to test VaultHelper logic in isolation.
//         // For integration testing with real contracts, see test_StakeAssetInVault_FeeOnTransferToken_IntegrationWithRealContracts
...
//         // Setup: Create mock contracts for isolated testing
//         address mockCollateral = makeAddr("MockCollateral");
//         address mockVault = makeAddr("MockVault");
        
//         // Mock the vault factory to recognize our mock vault
//         vm.mockCall(
//             address(vaultHelper.VAULT_FACTORY()),
//             abi.encodeWithSelector(IRegistry.isEntity.selector, mockVault),
//             abi.encode(true)
//         );
...
//         // Mock the vault's deposit function
//         vm.mockCall(
//             mockVault,
//             abi.encodeWithSelector(IVaultTokenized.deposit.selector, USER_ADDRESS, expectedReceived),
//             abi.encode(expectedReceived, expectedReceived) // Return (depositedAmount, mintedShares)
//         );
        
//         // Execute stakeAssetInVault - this should work with our fix
//         vm.prank(USER_ADDRESS);
//         vaultHelper.stakeAssetInVault(mockVault, USER_ADDRESS, mockCollateral, address(feeToken), depositAmount);
...
//         vm.mockCall(
//             mockVault,
//             abi.encodeWithSelector(IVaultTokenized.deposit.selector, USER_ADDRESS, depositAmount),
//             abi.encode(depositAmount, depositAmount) // Return (depositedAmount, mintedShares)
//         );
        
//         // Execute stakeAssetInVault
//         vm.prank(USER_ADDRESS);
//         vaultHelper.stakeAssetInVault(mockVault, USER_ADDRESS, mockCollateral, address(standardToken), depositAmount);
