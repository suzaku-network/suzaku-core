...
//     bytes constant VALIDATOR_NODE_ID_01 = bytes(hex"1234567812345678123456781234567812345678123456781234567812345678");
//     bytes constant VALIDATOR_NODE_ID_02 = bytes(hex"2345678123456781234567812345678123456781234567812345678123456781");
//     bytes constant VALIDATOR_NODE_ID_03 = bytes(hex"3456781234567812345678123456781234567812345678123456781234567812");
//     bytes constant VALIDATOR_01_BLS_PUBLIC_KEY = new bytes(48);
//     uint64 constant VALIDATOR_WEIGHT = 20;
//     bytes32 constant VALIDATION_ID_01 = 0x3a41d4db60b49389d4b121c2137a1382431a89369c5445c2a46877c3929dd9c6;
//     bytes32 constant VALIDATION_ID_02 = 0x0ff9e5c77da268eef8379d3ff1572d16d0fa519fcaa6f10b366c34ce3e97ca5a;
//     bytes32 constant VALIDATION_ID_03 = 0xff7f451c6758256d0b0a32a7e32aef5180693e6e296b329e80a8ee70cfb5f19a;
...
//         (address validatorManagerAddress,) = deployer.run(testSecurityModules[0], DEFAULT_MAX_WEIGHT, new bytes[](0));
//         validatorManager = BalancerValidatorManager(validatorManagerAddress);

//         ACP77WarpMessengerTestMock warpMessengerTestMock = new ACP77WarpMessengerTestMock(validatorManagerAddress);
...
//         validatorManager.initializeValidatorSet(_generateTestConversionData(), INITIALIZE_VALIDATOR_SET_MESSAGE_INDEX);
//         _;
//     }
...
//         validatorManager.initializeValidatorRegistration(_generateTestValidatorRegistrationInput(), VALIDATOR_WEIGHT);
//         _;
//     }
...
//         validatorManager.initializeValidatorRegistration(_generateTestValidatorRegistrationInput(), VALIDATOR_WEIGHT);
//         validatorManager.completeValidatorRegistration(COMPLETE_VALIDATOR_REGISTRATION_MESSAGE_INDEX);
//         vm.stopPrank();
//         _;
//     }

//     function _generateTestValidatorRegistrationInput() private view returns (ValidatorRegistrationInput memory) {
...
//         initialValidators[0] =
//             InitialValidator({nodeID: VALIDATOR_NODE_ID_02, weight: 180, blsPublicKey: VALIDATOR_01_BLS_PUBLIC_KEY});
//         initialValidators[1] =
//             InitialValidator({nodeID: VALIDATOR_NODE_ID_03, weight: 20, blsPublicKey: VALIDATOR_01_BLS_PUBLIC_KEY});
...
//         address[] memory securityModules = validatorManager.getSecurityModules();
//         (uint64 weight, uint64 maxWeight) = validatorManager.getSecurityModuleWeights(testSecurityModules[1]);
...
//                 IBalancerValidatorManager.BalancerValidatorManager__SecurityModuleNotRegistered.selector,
...
//         emit IBalancerValidatorManager.SetupSecurityModule(testSecurityModules[1], DEFAULT_MAX_WEIGHT);
//         validatorManager.setupSecurityModule(testSecurityModules[1], DEFAULT_MAX_WEIGHT);
//     }
...
//     function testCompleteValidatorRegistration() public validatorSetInitialized validatorRegistrationInitialized {
//         vm.prank(testSecurityModules[0]);
//         validatorManager.completeValidatorRegistration(COMPLETE_VALIDATOR_REGISTRATION_MESSAGE_INDEX);
...
//     function testInitializeValidatorWeightUpdate() public validatorSetInitialized validatorRegistrationCompleted {
...
//         vm.expectRevert(
//             abi.encodeWithSelector(
//                 IBalancerValidatorManager.BalancerValidatorManager__ValidatorNotBelongingToSecurityModule.selector,
//                 VALIDATION_ID_01,
//                 testSecurityModules[1]
//             )
//         );
...
//         vm.expectRevert(
//             abi.encodeWithSelector(
//                 IBalancerValidatorManager.BalancerValidatorManager__PendingWeightUpdate.selector, VALIDATION_ID_01
//             )
//         );
...
//         vm.expectRevert(
//             abi.encodeWithSelector(
//                 IBalancerValidatorManager.BalancerValidatorManager__SecurityModuleMaxWeightExceeded.selector,
//                 testSecurityModules[0],
//                 40,
//                 30
//             )
...
//     function testCompleteValidatorWeightUpdate() public validatorSetInitialized validatorRegistrationCompleted {
//         // Warp to 2024-01-01 02:00:00 to exit the churn period (1 hour)
//         vm.warp(1_704_067_200 + 2 hours);
...
//         validatorManager.completeValidatorWeightUpdate(VALIDATION_ID_01, COMPLETE_VALIDATOR_WEIGHT_UPDATE_MESSAGE_INDEX);
...
//     function testResendValidatorWeightUpdate() public validatorSetInitialized validatorRegistrationCompleted {
//         // Warp to 2024-01-01 02:00:00 to exit the churn period (1 hour)
//         vm.warp(1_704_067_200 + 2 hours);
...
//     function testInitializeEndValidation() public validatorSetInitialized validatorRegistrationCompleted {
//         vm.prank(testSecurityModules[0]);
...
//     function testCompleteEndValidationExpired() public validatorSetInitialized validatorRegistrationInitialized {
