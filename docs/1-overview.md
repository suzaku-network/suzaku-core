...
| Doc | Contents |
|-----|----------|
| [1. Overview](./1-overview.md) | This document — architecture, flow, components |
| [2. Stake Limits](./2-stake-limits.md) | Weight limiting factors, capacity subdivision |
| [3. Vault](./3-vault.md) | Vault mechanics, epoch withdrawals |
| [4. Middleware](./4-middleware.md) | Operator lifecycle, epoch system |
